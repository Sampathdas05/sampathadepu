...
public class CombinationOfStringArray {
	...
	public static void main(String[] args) {
		CombinationOfStringArray cmb = new CombinationOfStringArray();
		String[][] twoDimStringArray = new String[][]{{"sam", "path"}, {"kum", "ar"}};
		System.out.println(cmb.combinations(twoDimStringArray));
	}
